...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"4":"03972beb"}[chunkId] + ".js"
/******/ 	}
/******/
...
setTimeout(function () {
  __webpack_require__.e(/* import() */ 4).then(__webpack_require__.t.bind(null, 17, 7)).then(function (res) {
    console.log(res);
  });
}, 5000);
